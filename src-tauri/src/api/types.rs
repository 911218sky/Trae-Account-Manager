...
/// Raw JWT token data after parsing.
...
/// User information retrieved using token.
#[derive(Debug, Clone)]
...
/// Simplified usage summary for frontend display.
#[derive(Debug, Clone, Serialize, Deserialize)]
