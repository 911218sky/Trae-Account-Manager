...
export const AccountCard = memo(function AccountCard({ account, usage, selected, onSelect, onContextMenu }: AccountCardProps) {
    ...
    >
      <div className="card-header">
        ...
        <div className={`card-status ${tokenStatus === "expired" ? "expired" : tokenStatus === "expiring" ? "expiring" : "normal"}`}>
          ...
          {tokenStatus === "expired" ? "Expired" : tokenStatus === "expiring" ? "Expiring Soon" : "Normal"}
        </div>
      </div>
      ...
      <div className="card-usage">
        ...
        <div className="usage-numbers">
          ...
          <span className="usage-left">Remaining {Math.round(totalLeft)}</span>
        </div>
      </div>
      ...
      <div className="card-meta">
        ...
        {usage && usage.extra_expire_time > 0 && (
          <span className="meta-item warning">
            ...
            Gift Pack Expires {formatDate(usage.extra_expire_time)}
          </span>
        )}
      </div>
