    ...
    >
      ...
      <div className="list-item-plan">
        ...
        {usage && usage.extra_fast_request_limit > 0 && (
          <span className="extra-badge">Gift Pack</span>
        )}
      </div>
      ...
      <div className="list-item-reset">
        <span className="reset-label">Added</span>
      ...
      <div className="list-item-status">
        ...
        <span>{tokenStatus === "expired" ? "Expired" : tokenStatus === "expiring" ? "Expiring Soon" : "Normal"}</span>
      </div>
