...
export async function getAccountsPaginated(
  ...
  return invoke("get_accounts_paginated", { page, pageSize });
}
...
export async function rollbackAccount(): Promise<void> {
  return invoke("rollback_account");
}
...
export async function exportSelectedAccounts(
  ...
  return invoke("export_selected_accounts", { accountIds, format });
}
...
export async function refreshActiveToken(): Promise<void> {
  return invoke("refresh_active_token");
}
...
export async function checkTokenExpiry(): Promise<boolean> {
  return invoke("check_token_expiry");
}
